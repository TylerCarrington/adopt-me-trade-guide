...
const PetRow = ({ pet, onSelectPet }) => {
  return (
    <tr>
      ...
      <td className="calculation">{formatForDisplay('Rate', pet['Neon Rate'])}</td>
      <td className="calculation">{formatForDisplay('Gain', pet['Neon Gain'])}</td>
      <td className="calculation">{formatForDisplay('Rate', pet['Mega Rate'])}</td>
      <td className="calculation">{formatForDisplay('Gain', pet['Mega Gain'])}</td>
      <td className="calculation">
        {formatForDisplay('Weighted Gain', pet['Weighted Neon Gain'])}
      </td>
      <td className="calculation">{formatForDisplay('Tasks', pet.Tasks)}</td>
